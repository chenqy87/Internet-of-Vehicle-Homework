...
def process_frame_pic_backup(img):
    start = timer()
...
#     img_binary = find_edges(img_resize)
    ...
    range_0 = cv2.inRange(img_hsv,lower_white,higher_white)
    image = cv2.bitwise_and(img_resize,img_resize,mask = range_0)
    img_binary = process_an_image(image,img_resize)
